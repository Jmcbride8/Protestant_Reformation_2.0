            ...
            {scheduleItems.filter(item => item.is_active !== false).map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center gap-6 p-6 rounded-xl bg-primary-foreground/10 border border-primary-foreground/20 shadow-sm"
                >
                  ...
                  <div className="flex-1">
                    <h4 className="font-heading text-lg text-primary-foreground">{item.event}</h4>
