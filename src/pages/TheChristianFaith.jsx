...
function HistorySection({ isAdmin }) {
  ...
  const cards = [
    ...
    },
    {
      key: 'hist_nero',
      year: 'AD 64–68',
      name: 'Nero & Roman Persecution',
      subtitle: 'Blood of the Martyrs',
      desc: 'After the Great Fire of Rome, Emperor Nero blamed the Christians — a small, despised minority. What followed was savage: believers were burned as torches, thrown to lions, and crucified. Yet the church did not shrink. The willingness of ordinary men and women to die rather than recant proved the resurrection was no legend. Tertullian would later write: "The blood of the martyrs is the seed of the church."',
      image: 'https://images.unsplash.com/photo-1552083375-1447ce886485?w=800&q=80',
    },
    {
    ...
    },
    {
      ...
      subtitle: 'Defining Orthodoxy',
      desc: 'Emperor Constantine convened 300 bishops from across the empire to settle a crisis: was Jesus truly God, or a created being? The council\'s answer — that Christ was fully divine, of the same substance as the Father — became the Nicene Creed, still recited by billions today. It was Christianity\'s first great act of theological self-definition, and its conclusions have held for seventeen centuries.',
...

    {
      ...
      year: '2000s–Present',
      name: 'The New Atheist Debates',
      subtitle: 'Faith Under the Microscope',
      desc: 'Richard Dawkins, Christopher Hitchens, and Sam Harris launched a high-profile assault on religion in the early 2000s, arguing that faith was irrational and harmful. Yet the intellectual response was formidable: philosophers and theologians like William Lane Craig, Alvin Plantinga, and John Lennox met them in public debate, arguing that God\'s existence is not only reasonable but the best explanation for the universe\'s existence, fine-tuning, moral reality, and the historical resurrection. The debates continue — and remain some of the most important of our time.',
