      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <EditableText
            ...
            defaultText={`VIVE Church is thriving, well-led, and genuinely welcoming. The pastors are truly hospitable people — but they're still human, and as the church grew, they couldn't reach everyone the way they once could. The production got better, the teaching sharper, the polish more impressive. But somewhere in that climb, programming and excellence began to come at the expense of people and relationships. Like most growing congregations, it faced a real question: "How do we keep feeling like a family as we grow?" This site experiments with that very problem — building relational infrastructure that lets warmth scale. You can grow and still feel like home.`}
            className="font-body text-muted-foreground leading-relaxed max-w-3xl mb-8"
            isAdmin={isAdmin}
          />
        </motion.div>
